...
#+COLUMNS: %52ITEM(Task) %15SCHEDULED(Planned End Data) %19CLOSED(Actual End Date) %15Progress(Progress){X} %15Effort(Estimated Effort){:} %7CLOCKSUM(Actual Effort){:}
...
**** DONE create trie printer
     CLOSED: [2016-01-31 Sun 19:19]
     :LOGBOOK: 
     CLOCK: [2016-02-01 Mon 20:58]
     CLOCK: [2016-02-01 Mon 19:24]--[2016-02-01 Mon 19:28] =>  0:04
...
**** DONE create insert function
     ...
     :END:      
**** NEXT create a simple parser
     SCHEDULED: <2016-02-02 Tue>
     :LOGBOOK:  
     CLOCK: [2016-02-02 Tue 08:53]
     :END:      
*** TODO testing
